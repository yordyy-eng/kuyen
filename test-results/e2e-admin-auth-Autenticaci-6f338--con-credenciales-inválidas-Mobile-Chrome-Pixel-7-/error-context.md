...
- Name: e2e\admin-auth.spec.ts >> Autenticación Admin >> debe mostrar error con credenciales inválidas
- Location: tests\e2e\admin-auth.spec.ts:31:7
...
Locator: getByText(/Credenciales inválidas/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/Credenciales inválidas/i)
      ...
      - generic [ref=e10]:
        ...
        - generic [ref=e14]:
          ...
          - generic [ref=e19]:
            - alert [ref=e20]:
              - generic [ref=e21]: ⚠
              - generic [ref=e22]: Credenciales incorrectas.
            - generic [ref=e23]:
              - generic [ref=e24]: Correo electrónico
              - textbox "Correo electrónico" [ref=e25]:
                - /placeholder: admin@kuyen.cl
            - generic [ref=e26]:
              - generic [ref=e27]: Contraseña
              - textbox "Contraseña" [ref=e28]:
                - /placeholder: ••••••••
            - button "Acceder al panel" [ref=e29]
        - paragraph [ref=e30]: © 2026 KUYEN — Municipalidad de Angol
  - contentinfo [ref=e31]:
    - generic [ref=e32]:
      - paragraph [ref=e33]: Sistema KUYEN
      - paragraph [ref=e34]: Municipalidad de Angol
      - paragraph [ref=e36]: Desarrollado sobre OCI • 2024
