...
- Name: e2e\contribution.spec.ts >> Contribución Ciudadana >> debe cargar el formulario y enviar una propuesta válida
- Location: tests\e2e\contribution.spec.ts:10:7
...
Locator: getByText(/Contribuir al legado/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/Contribuir al legado/i)
