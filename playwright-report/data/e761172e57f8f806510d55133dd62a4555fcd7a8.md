...
- Name: e2e\admin-auth.spec.ts >> Autenticación Admin >> debe permitir el acceso con credenciales válidas
- Location: tests\e2e\admin-auth.spec.ts:16:7
...
Expected: "http://127.0.0.1:3000/admin"
Received: "http://127.0.0.1:3000/admin/login"
Timeout:  10000ms
